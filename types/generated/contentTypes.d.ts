...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    CodGatewayId: Attribute.String & Attribute.Required & Attribute.Unique;
    ...
    > &
      Attribute.Required;
    deliveryCharge: Attribute.Integer &
      Attribute.SetMinMax<
        {
          min: 0;
        },
        number
      >;
    estimatedDeliveryTime: Attribute.String;
    comments: Attribute.Text;
    fullAddress: Attribute.RichText & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
